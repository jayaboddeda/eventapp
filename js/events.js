    ...
    getDefaultEvents().then(function (result) {
        ...
        if(response !=null || response !='' || response !=undefined){
            ...
            for(var i=0; i<response.length; i++){
                ...
                let eventhtml = `<div class="swiper-slide slider-simple__slide" data-eventid="${response[i].eventid}"><div class="event-info-wrap" data-topbottom="${response[i].eventid}"><div class="event-top-content" data-top="${response[i].eventid}"><img src="imgs/event-db-img.jpg" class="img-fluid event-db-img"><div class="event-db-details"><h2 class="caption__title">${response[i].eventname}</h2><div class="event-db-bottom-details"><div class="caption__desc"><img src="imgs/calendar (2).svg"><span>${response[i].startdate} to ${response[i].enddate}</span></div><div class="caption__desc"><img src="imgs/location.svg"> <span>${response[i].cityname}</span></div></div></div></div><div class="event-bottom-content" data-bottom="${response[i].eventid}"><div class="plan-a-trip-wrap"><div class="page__title-bar"><h2>Plan a Trip</h2></div><div class="row plan-trip-content-wrap" data-plantrip="${response[i].eventid}"></div></div><div class="my-bookings-wrap pb-20 pt-20"><div class="page__title-bar"><h2>My Bookings</h2></div><div class="my-bookings-content" data-mybookingevent="${response[i].eventid}"></div></div></div></div></div>`;
